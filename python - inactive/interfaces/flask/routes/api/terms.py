...
def create_term():
    ...
    Request body (JSON):
        ...
        target_date: str (optional) - ISO datetime string (calculated if omitted)
        theme: str (optional) - Focus area for this term
        term_goals_by_id: list[int] (optional) - Goal IDs assigned to this term
...
def update_term(term_id: int):
    ...
    Request body (JSON):
        Any term field to update (theme, reflection, start_date, target_date, term_goals_by_id)
...
def add_goal_to_term(term_id: int):
    ...
    Adds a goal ID to the term's term_goals_by_id list (commitment).
...
def remove_goal_from_term(term_id: int, goal_id: int):
    ...
    Removes a goal ID from the term's term_goals_by_id list.
