...
// - GoalMetric structs store measurement targets (0 to many)
// - Services examine Goal + GoalMetrics to determine classification
//
// CLASSIFICATIONS:
...
/// - Classification is **derived state** based on Goal + GoalMetrics
...
/// let metrics = [GoalMetric(goalId: goal.id, metricId: km, targetValue: 120.0)]
///
...
public struct GoalValidation {
    ...
    public static func classify(_ goal: Goal, metrics: [GoalMetric]) -> GoalClassification {
