...
public final class HealthKitImportService {
    ...
    public func importWorkout(_ workout: HealthWorkout) async throws -> Action {
        return try await database.write { db in
            ...
            let durationValue = workout.duration >= 3600
    ...
    nonisolated private func findOrCreateMeasure(
        ...
        if let existing = allMeasures.first(where: { $0.unit == unitValue && $0.measureType == typeValue }) {
            return existing
        }
        ...
        return try Measure.upsert {
            Measure.Draft(
                ...
                freeformNotes: nil,
                unit: unitValue,
                measureType: typeValue,  // Fixed: measureType not metricType
...
public final class HealthKitImportService {
    ...
    public func importWorkout(_ workout: HealthWorkout) async throws -> Action {
        throw NSError(domain: "HealthKitImportService", code: -1, userInfo: [
