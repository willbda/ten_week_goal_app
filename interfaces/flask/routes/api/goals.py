...
def get_goals():
    ...
    Returns:
        200: JSON array of goal objects
        500: Server error
...
def create_goal():
    ...
    Request body (JSON):
        ...
        start_date: str (optional) - ISO datetime string
        end_date: str (optional) - ISO datetime string
    ...
    try:
        ...
        logger.info(f"Created goal {goal.id}: {goal.description}")
